...
CREATE TABLE Sale (sale BIGINT AUTO_INCREMENT PRIMARY KEY NOT NULL, operation BIGINT NOT NULL, stock BIGINT NOT NULL, item BIGINT NOT NULL, amount TINYINT NOT NULL);
