...
CREATE TABLE Stocking_Production ( item INT NOT NULL,subitem INT  NOT NULL, step INT NOT NULL DEFAULT 0,FOREIGN KEY(item) REFERENCES Stocking(id),FOREIGN KEY(subitem) REFERENCES Entities(id),FOREIGN KEY(subitem) REFERENCES Catalog_Items(id));
