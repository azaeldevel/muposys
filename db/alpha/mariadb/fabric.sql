...
CREATE TABLE ProgressTrace (trace BIGINT, stocking BIGINT NOT NULL, operation BIGINT NOT NULL, step TINYINT NOT NULL DEFAULT 0 COMMENT 'Identificador de progreso actual');
