...
muposys::http::Session& Login2::getSession()
{
	return *session;
}
Login2::Login2()
...
Login2::Login2(const muposys::Body& b) : muposys::HTML(b)
{
	session = new muposys::http::Session;
}
Login2::~Login2()
...
const std::string& Login2::getSessionID()const
{
	return session->getSessionID();
}
bool Login2::check(const std::string& userstr,const std::string& password) const
{
#if defined MARIADB
	octetos::db::maria::Connector conn;
#elif defined MYSQL
...
void Login2::print(std::ostream& out) const
{
